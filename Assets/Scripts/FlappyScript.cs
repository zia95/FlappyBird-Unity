...
public class FlappyScript : MonoBehaviour
{
    ...
    public GameObject MenuGUI, DeathGUI;
    public Collider2D restartButtonGameCollider;
    public float VelocityPerJump = 0.0f;
    ...
    void Update()
    {
        ...
        else if (GameStateManager.GameState == GameState.Intro)
        {
            ...
            if (GameLauncher.GameDifficulty == GameLauncher.Difficulty.Easy) VelocityPerJump = 2.5f;
            else if (GameLauncher.GameDifficulty == GameLauncher.Difficulty.Medium) VelocityPerJump = 2.8f;
            else VelocityPerJump = 3.0f;
    ...
    void FixedUpdate()
    {
        ...
        if (GameStateManager.GameState == GameState.Playing || GameStateManager.GameState == GameState.Dead)
        {
            FixFlappyRotation();
        }
        else if (GameStateManager.GameState == GameState.Intro)
